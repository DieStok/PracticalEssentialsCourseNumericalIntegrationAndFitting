...
#note that we use the tweak: OD=N1+N2 to plot as extra the total density from N1 and N2 summed
...
#larger, and once strain1 has reached a sufficient level strain2 numbers have dropped already significantly #making it hard to estimate c2. 
```
